...
$Form.ClientSize = New-Object System.Drawing.Point(1050, 900)
$Form.text = "Form"
$Form.TopMost = $false
...
$customPanel.height = 135
$customPanel.width = 588
$customPanel.location = New-Object System.Drawing.Point(9, 680)
$customTweaks = New-Object system.Windows.Forms.Button
$customTweaks.text = "Custom Coded Tweaks"
$customTweaks.width = 200
$customTweaks.height = 115
$customTweaks.location = New-Object System.Drawing.Point(16, 10)
$customTweaks.Font = New-Object System.Drawing.Font('Microsoft Sans Serif', 16)

$Form.controls.AddRange(@($Panel1, $Label1, $Panel2, $Label3, $Panel3, $Label4, $Label15, $Panel4, $Label20, $Label21, $Label23, $PictureBox1, $customPanel))
...
$customPanel.controls.AddRange(@($customTweaks))
...
$customTweaks.Add_Click( {
		Write-Host "Custom Tweaks..."
		...
		Write-Host "...Installing Authy Desktop"
